...
Flow::Flow(NetworkInterface *_iface,
  ...
  srcAS = dstAS = collection.prevAdjacentAS = collection.nextAdjacentAS = 0;
  ...
  tcp.src2dst_tcp_flags = 0, tcp.dst2src_tcp_flags = 0, last_update_time.tv_sec = 0,
  ...
  collection.wifi.wlan_ssid = NULL;
  memset(collection.wifi.wtp_mac_address, 0, sizeof(collection.wifi.wtp_mac_address));
  ...
  collection.nat.src_ip_addr_pre_nat = collection.nat.dst_ip_addr_pre_nat =
    collection.nat.src_ip_addr_post_nat = collection.nat.dst_ip_addr_post_nat = 0;  
  collection.nat.src_port_pre_nat = collection.nat.dst_port_pre_nat =
    collection.nat.src_port_post_nat = collection.nat.dst_port_post_nat = 0;
  ...
  */
  ...
  tcp.synTime.tv_sec = tcp.synTime.tv_usec = 0, tcp.ackTime.tv_sec = tcp.ackTime.tv_usec = 0,
    tcp.synAckTime.tv_sec = tcp.synAckTime.tv_usec = 0, rttSec = 0,
    tcp.cli2srv_window = tcp.srv2cli_window = 0,
  ...
  memset(&tcp.tcp_seq_s2d, 0, sizeof(tcp.tcp_seq_s2d)),
    memset(&tcp.tcp_seq_d2s, 0, sizeof(tcp.tcp_seq_d2s));
