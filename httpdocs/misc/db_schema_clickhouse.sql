...
@
ALTER TABLE flows MODIFY COLUMN `SRC_NETWORK_ID` UInt32; /* Migrate from UInt16 */
@
ALTER TABLE flows ADD COLUMN IF NOT EXISTS `DST_NETWORK_ID` UInt32;
@
ALTER TABLE flows MODIFY COLUMN `DST_NETWORK_ID` UInt32; /* Migrate from UInt16 */
@
...
@
ALTER TABLE `hourly_flows` MODIFY COLUMN `SRC_NETWORK_ID` UInt32; /* Migrate from UInt16 */
@
ALTER TABLE `hourly_flows` MODIFY COLUMN `DST_NETWORK_ID` UInt32; /* Migrate from UInt16 */
