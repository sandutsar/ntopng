...
@
ALTER TABLE `flows` ON CLUSTER '$CLUSTER' MODIFY COLUMN `SRC_NETWORK_ID` UInt32; /* Migrate from UInt16 */
@
ALTER TABLE `flows` ON CLUSTER '$CLUSTER' ADD COLUMN IF NOT EXISTS `DST_NETWORK_ID` UInt32;
@
ALTER TABLE `flows` ON CLUSTER '$CLUSTER' MODIFY COLUMN `DST_NETWORK_ID` UInt32; /* Migrate from UInt16 */
@
...
@
ALTER TABLE ``hourly_flows ON CLUSTER '$CLUSTER' MODIFY COLUMN `SRC_NETWORK_ID` UInt32; /* Migrate from UInt16 */
@
ALTER TABLE ``hourly_flows ON CLUSTER '$CLUSTER' MODIFY COLUMN `DST_NETWORK_ID` UInt32; /* Migrate from UInt16 */
