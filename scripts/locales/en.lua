local lang = {
  ...
  ["acl_page"] = {
      ...
      ["non_blocking_rules"] = "This rules are NOT used to blocking traffic",
      ["add_new_rule"] = "To add a new rule, click the <i class='fas fa-plus'></i> button above the table",
      ["edit_arp_only_client"] = "In case of ARP protocol, only the client is needed",
      ["edit_arp_use_mac"] = "In case of ARP protocol, the client needs to be a MAC Address",
      ["edit_acl_required"] = "All the fields except for the Port/App. are required",
      ["edit_acl_empty_port_app"] = "Leave the Port field empty if it is not needed",
      ["edit_acl_switch_port_app"] = "Click on the 'Port' to be able to add a port; click on 'App.' to be able to choose an Application protocol",
      ["edit_acl_rule"] = "Edit Rule",
      ["use_port"] = "Port",
      ["edit_acl_notes"] = "In the 'Notes' it is possible to add whatever note the user want",
      ["use_application"] = "App.",
      ...
      ["add_rule_plus"] = "Click the <i class='fas fa-plus'></i> button to add an other rule, click the <i class='fas fa fa-trash'></i> to remove a rule",
